<section class="hero-program-section">
    <div class="hero-program-background">
        <img src="{{ asset('img/stamina.svg') }}" alt="Program Turun Berat Badan Background" class="hero-bg-image">
        <div class="hero-overlay"></div>
    </div>
    <div class="hero-program-content">
        <h1 class="hero-program-title">Program Stamina & Energi</h1>
        <p class="hero-program-description">
            Ikuti program peningkatan stamina dan energi yang dirancang dengan latihan cardio teratur, pola makan seimbang, dan kebiasaan hidup
            sehat agar tubuh lebih bugar dan tahan lama dalam beraktivitas.
        </p>
