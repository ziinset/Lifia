...
<head>
    ...
    <title>Artikel Kesehatan Mental - Admin Lifia</title>
        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1 class="page-title">Artikel Kesehatan Mental</h1>
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="article-title">Mengatasi Stress dan Kecemasan</td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td class="article-title">Pentingnya Self-Care dalam Kehidupan</td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td class="article-title">Teknik Meditasi untuk Pemula</td>
