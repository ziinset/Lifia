    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-links" id="navbarLinks">
                ...
                @endphp
                <a href="{{ route('profil') }}" class="navbar-account" style="display:flex; align-items:center; gap:10px; text-decoration:none; color:#fff; border:1.4px solid #fff; border-radius:30px; padding:7px 14px; background:transparent;">
