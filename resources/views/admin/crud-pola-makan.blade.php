...
<head>
    ...
    <title>Artikel Pola Makan Sehat - Admin Lifia</title>
        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1 class="page-title">Artikel Pola Makan Sehat</h1>
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="article-title">Lorem Ipsum</td>
                                    <td class="timestamp">19:40:35</td>
                                    <td class="author">Goldi</td>
                                    <td>
