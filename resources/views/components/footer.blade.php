...
<body>
    ...
    <footer style="background-color: #3B5C3F; color: white; padding: 0; margin: 0; position: relative; overflow: hidden;">
        ...
        <div class="footer-container" style="position: relative; z-index: 2; max-width: 1200px; margin: 0 auto; padding: 100px 20px 30px 20px;">
            <div class="footer-content" style="display: grid; grid-template-columns: 2fr 1fr 1.5fr 1fr; gap: 30px; margin-bottom: 40px; align-items: start;">
                ...
                <div style="padding-right: 20px; position: relative;">
                    ...
                    <div style="display: flex; gap: 20px;">
                        <a href="#" class="social-icon" style="display: flex; align-items: center; justify-content: center; width: 50px; height: 50px; background-color: rgba(255,255,255,0.1); border-radius: 50%; text-decoration: none; border: 2px solid rgba(255,255,255,0.2);">
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="margin-bottom: 12px;">
                            <a href="#" class="footer-link" style="font-family: 'Montserrat', sans-serif; color: #c8d8c8; text-decoration: none; font-size: 16px; font-weight: 400; display: block;">Tentang Kami</a>
                        </li>
                        <li style="margin-bottom: 12px;">
                            <a href="#" class="footer-link" style="font-family: 'Montserrat', sans-serif; color: #c8d8c8; text-decoration: none; font-size: 16px; font-weight: 400; display: block;">Tim Penulis</a>
                        </li>
                        <li style="margin-bottom: 12px;">
                            <a href="#" class="footer-link" style="font-family: 'Montserrat', sans-serif; color: #c8d8c8; text-decoration: none; font-size: 16px; font-weight: 400; display: block;">Karir</a>
                        </li>
                    </ul>
                </div>
            ...
            <!-- Copyright Section -->
            <div class="copyright" style="border-top: 1px solid rgba(255,255,255,0.2); padding-top: 20px; text-align: center;">
