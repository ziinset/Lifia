...
<head>
    ...
    <title>Artikel Aktivitas Fisik - Admin Lifia</title>
        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1 class="page-title">Artikel Aktivitas Fisik</h1>
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="article-title">Panduan Olahraga untuk Pemula</td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td class="article-title">Manfaat Yoga untuk Kesehatan</td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td class="article-title">Tips Cardio yang Efektif</td>
