...
<<<<<<< HEAD
                            <img src="{{ asset('image/ph_plant-fill.png') }}" alt="Eco icon"
                                class="tag-fish-icon">
                            <span class="tag-text">Eco Living</span>
                        </div>
...
<<<<<<< HEAD
                    ...
                    <div class="article-content">
                        <div class="article-tag">
                            <img src="{{ asset('image/ph_plant-fill.png') }}" alt="Rawat icon"
                                class="tag-fish-icon">
                            <span class="tag-text">Eco Living</span>
                        </div>
...
>>>>>>> jonathan
                        ...
                        <div class="category-item">
<<<<<<< HEAD
                            <img src="{{ asset('img/mental-aksicepat.svg') }}" alt="Eco Living"
                                class="category-icon">
                            <span class="category-text">Eco Living</span>
                        </div>
...
>>>>>>> jonathan
                        ...
                        <div class="category-item">
<<<<<<< HEAD
                            <img src="{{ asset('img/vegan-aksicepat.png') }}" alt="Eco Living"
                                class="category-icon">
                            <span class="category-text">Eco Living/<br>Vegetarian</span>
                        </div>
