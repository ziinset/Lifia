...
<<<<<<< HEAD
                ...
                <div class="main-article-content">
                    <div class="main-category-tag">
                        <div class="main-category-icon" style="background-image: url('{{ asset('image/ri_mental-health-fill.png') }}');"></div>
                        Kesehatan Mental
                    </div>
...
<<<<<<< HEAD
                                <div class="sidebar-category-icon" style="background-image: url('{{ asset('image/ri_mental-health-fill.png') }}');"></div>
                                Kesehatan Mental
=======
