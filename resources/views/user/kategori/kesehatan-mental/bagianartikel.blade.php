                ...
                <div class="main-article-content">
                    ...
                    <div class="main-article-meta">
                        ...
                        <div class="main-article-actions">
                            <button class="main-action-btn" onclick="window.location.href='{{ route('kategori.kesehatan-mental.artikel.artikel') }}'">Selengkapnya</button>
                    ...
                    <div class="sidebar-article-content">
                        ...
                        <div class="sidebar-article-footer">
                            ...
                            <div class="sidebar-article-actions">
                                <button class="sidebar-action-btn" onclick="window.location.href='{{ route('kategori.kesehatan-mental.artikel.artikel') }}'">selengkapnya</button>
