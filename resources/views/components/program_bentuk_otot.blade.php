<section class="hero-program-section">
    <div class="hero-program-background">
        <img src="{{ asset('img/bentuk_otot.svg') }}" alt="Program Turun Berat Badan Background" class="hero-bg-image">
        <div class="hero-overlay"></div>
    </div>
    <div class="hero-program-content">
        <h1 class="hero-program-title">Program Bentuk Otot</h1>
        <p class="hero-program-description">
            Ikuti program pembentukan otot yang dirancang dengan latihan kekuatan, pola makan tinggi
            protein, dan strategi pemulihan optimal untuk hasil yang maksimal.
        </p>
