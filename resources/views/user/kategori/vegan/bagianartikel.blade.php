...
<<<<<<< HEAD
                ...
                <div class="main-article-content">
                    <div class="main-category-tag">
                        <div class="main-category-icon" style="background-image: url('{{ asset('image/flowbite_carrot-solid.png') }}');"></div>
                        Gaya Hidup Vegan
                    </div>
...
<<<<<<< HEAD
                                <div class="sidebar-category-icon" style="background-image: url('{{ asset('image/flowbite_carrot-solid.png') }}');"></div>
                                Gaya Hidup Vegan
=======
