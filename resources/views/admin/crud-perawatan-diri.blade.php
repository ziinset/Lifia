...
<head>
    ...
    <title>Artikel Perawatan Diri - Admin Lifia</title>
        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1 class="page-title">Artikel Perawatan Diri</h1>
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="article-title">Rutinitas Skincare yang Tepat</td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td class="article-title">Tips Perawatan Rambut Alami</td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td class="article-title">Manfaat Minum Air Putih untuk Kulit</td>
