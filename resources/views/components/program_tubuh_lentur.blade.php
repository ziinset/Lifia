<section class="hero-program-section">
    <div class="hero-program-background">
        <img src="{{ asset('img/lentur.svg') }}" alt="Program Turun Berat Badan Background" class="hero-bg-image">
        <div class="hero-overlay"></div>
    </div>
    <div class="hero-program-content">
        <h1 class="hero-program-title">Program Tubuh Lebih Lentur</h1>
        <p class="hero-program-description">
            Ikuti program fleksibilitas yang dirancang dengan latihan peregangan, yoga, dan mobilitas
            sendi untuk membuat tubuh lebih lentur, rileks, serta mengurangi risiko cedera.
        </p>
