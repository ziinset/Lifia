...
<head>
    ...
    <title>Artikel Eco Living - Admin Lifia</title>
        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h1 class="page-title">Artikel Eco Living</h1>
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="article-title">Tips Mengurangi Sampah Plastik</td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td class="article-title">Cara Membuat Kompos di Rumah</td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td class="article-title">Produk Ramah Lingkungan untuk Sehari-hari</td>
