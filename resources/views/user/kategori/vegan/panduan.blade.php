...
<<<<<<< HEAD
                            <img src="{{ asset('image/flowbite_carrot-solid.png') }}" alt="Rawat icon"
                                class="tag-fish-icon">
                            <span class="tag-text">Gaya Hidup Vegan</span>
                        </div>
...
>>>>>>> jonathan
                        ...
                        <div class="category-item">
<<<<<<< HEAD
                            <img src="{{ asset('img/mental-aksicepat.svg') }}" alt="Gaya Hidup Vegan"
                                class="category-icon">
                            <span class="category-text">Gaya Hidup Vegan</span>
                        </div>
