            ...
            <div class="main-article-container">
                ...
                <div class="main-article-content">
                    <div class="main-category-tag">
                        <div class="main-category-icon" style="background-image: url('{{ asset('image/ph_plant-fill.png') }}');"></div>
                        Eco Living
                    </div>
                    ...
                    <div class="sidebar-article-content">
                        <div class="sidebar-content-top">
                            <div class="sidebar-category-tag">
                                <div class="sidebar-category-icon" style="background-image: url('{{ asset('image/ph_plant-fill.png') }}');"></div>
                                Eco Living
                            </div>
